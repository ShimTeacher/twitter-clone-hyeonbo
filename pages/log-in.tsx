  ...
  <div className="bg-black h-screen flex flex-col justify-between items-center">
    ...
    <div className="flex flex-col items-start gap-5 pt-5">
      ...
      <form className="w-full">
        <input type="text" className="appearance-none w-full px-3 py-5 border-4 bg-black rounded-md shadow-sm text-white placeholder-gray-400 focus:outline-none  focus:border-[#339aef] " placeholder="휴대폰 번호, 이메일 주소 또는 사용자 아이디"/>
      </form>
