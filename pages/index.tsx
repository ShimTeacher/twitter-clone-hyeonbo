    ...
    <div className="flex-1 h-screen overflow-y-scroll border-r border-gray-800 ">
      <div className="p-4 bg-black border-b  border-gray-800">
        <div className="flex justify-between">
          ...
          <svg className="w-6 h-6 text-white text-2xl" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
        </div>
        <div className="flex mt-5 ">
          ...
          <div className="flex-1 bg-black">
            <div className="ml-2 p-1 flex justify-center items-center w-24 rounded-full border-gray-800 border-2 cursor-pointer">
              ...
              <svg className="w-4 h-4 text-[#2D8CD7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
            </div>
            ...
            <form onSubmit={handleSubmit(onValid)} >
                ...
                <div className="flex justify-between items-center border-t-2 border-gray-800">
                  <div className="flex items-center p-5 gap-3">
                    ...
                    <svg className="w-6 h-6 text-[#2D8CD7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <svg className="w-6 h-6 text-[#2D8CD7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 14l9-5-9-5-9 5 9 5z"></path><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"></path></svg>
                    <svg className="w-6 h-6 text-[#2D8CD7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>  
                 </div>
                <button type="submit" className="flex-end right-5 pl-8 pr-8 pt-2 pb-2 rounded-full text-white bg-[#2D8CD7]">트윗하기</button>
                </div>
              </form>
            </div>
          </div>
        ...
        {tweets?.map(item => {
          return (<article key={item.id} className="cursor-pointer p-4 bg-black border-b  border-gray-800">
          ...
          <div className="flex-1 ml-3">
            ...
            <div className="grid grid-cols-4 pb-2 cursor-pointer">
              <div className="group flex gap-2 items-center cursor-pointer">
                ...
                <span className="text-gray-600 text-sm group-hover:text-[#2D8CD7]">0</span>
              </div>
              ...
              <div className="group flex gap-2 items-center cursor-pointer">
                ...
                <span className="text-gray-600 text-sm group-hover:text-[#24BA7B]">0</span>
              </div>

              <div className="group flex gap-2 items-center cursor-pointer">
                <div onClick={likeClicked} className="flex justify-start items-center  group-hover:bg-[#181819] rounded-full p-1">
                  <svg className="text-gray-600 w-6 h-6 group-hover:text-[#C91267]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                </div>
                      <span className="text-gray-600 text-sm group-hover:text-[#C91267]">{item?.Likes.length}</span>
              </div>
