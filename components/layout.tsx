...
export default function Layout({
  ...
  return (
    ...
    <div onClick={onClickHomeRoute} className="border-r border-gray-800 flex flex-col gap-2  xl:w-60">
      <svg
      ...
      <div onClick={onClickHomeRoute} className="flex justify-start items-center  hover:bg-[#181819] rounded-full cursor-pointer ml-2 mr-2">
      ...
      <div className="flex justify-center items-center  rounded-full cursor-pointer ">
        ...
        <div className="flex flex-1 justify-center items-end">
          <div className="flex flex-row justify-center items-center">
            ...
            <span className="hidden text-white xl:block pr-6">{ user?.email}</span>
          </div>
      </div>
    </div>
